...
import { Mail, Lock, User, Phone, ArrowRight, Check, Shield, Zap, Globe, ChevronLeft, Gift, Award, AlertCircle } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Multi-layer encryption and cold storage protection',
    },
    {
      icon: <Zap size={24} />,
      title: 'Lightning Fast',
      description: 'Execute trades with our high-performance matching engine',
    },
    {
      icon: <Globe size={24} />,
      title: 'Global Access',
      description: 'Trade 24/7 from anywhere worldwide',
    },
  ];
